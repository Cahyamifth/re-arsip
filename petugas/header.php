...
<head>
    ...
    <title>Petugas - Sistem Informasi Arsip Kredit Digital</title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                ...
                <strong><a href="index.html"><img src="../assets/img/logo/logo4.png" alt="" /></a></strong>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="header-top-wraper">
                                <div class="row">
                                    <div class="col-lg-1 col-md-0 col-sm-12 col-xs-12" style="width: 1px">
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12" style="margin-right: 56px">
