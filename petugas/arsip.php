            ...
            <center>
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "gagal"){
                        ...
                        ?>
                        <div class="alert alert-danger">Arsip berhasil dihapus.</div>
                        <?php
                      }else{
                        ?>
                    ...
                    while($p = mysqli_fetch_array($arsip)){
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <b>Kode Referensi</b> : <?php echo $p['arsip_kode'] ?><br>
                                <b>No. Box</b> : <?php echo $p['box'] ?><br>
                                <b>Nama Debitur</b> : <?php echo $p['arsip_nama'] ?><br>
                                <b>Tgl Kredit</b> : <?php echo $p['tglkredit'] ?> <?php echo $p['tglakhir'] ?><br>
                                <b>No. Telepon</b> : <?php echo $p['notlp'] ?><br>
